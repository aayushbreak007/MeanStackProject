...
export class CountryService {
  ...
  private baseUri:string="http://localhost:8080";//backened apps runs on this port

  private headers=new HttpHeaders().set('Content-Type','application/json');//define the header
